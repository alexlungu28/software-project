...
//            // TODO: Department can be multi-value, separated by semi-columns?
            'department' => null,
        ]);
     ...
     * @return SamlAffiliationType
     */
    public function determineAffiliation(Saml2User $samlUser): SamlAffiliationType
    {
        ...
        if (is_null($affiliations) || !is_array($affiliations)) {
            ...
            return SamlAffiliationType::UNDETERMINED();
        ...
        $affiliation = SamlAffiliationType::UNDETERMINED();
        ...
        if ($affiliation->is(SamlAffiliationType::UNDETERMINED())) {
