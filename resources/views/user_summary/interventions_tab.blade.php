<div class="tab-pane fade show" id="interventionsTab" role="tabpanel" aria-labelledby="pills-interventions-tab">
                                ...
                                @foreach($groupInterventions as $intervention)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif($intervention->status == 3)
                                                <button class="btn btn-outline-danger rounded-pill"  type="button" name="update"  data-toggle="modal" data-target="{{"#statusGroupIntervention" . $intervention->id}}">  <span>Closed</span>
                                                    <br>
                                                    <span>Unsolved</span></button>
                                            @else
                                                <button class="btn btn-outline-secondary rounded-pill" type="button" name="update"  data-toggle="modal" data-target="{{"#statusGroupIntervention" . $intervention->id}}">  <span>Closed</span>
                                                    <br>
                                                    <span>Solved</span></button>
                                            @endif
