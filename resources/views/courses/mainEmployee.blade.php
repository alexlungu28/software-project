...
@section('content')
    <div class="content" style="display: flex;">
        ...
        <div class="container-fluid">
            ...
            <div class="container" style="width: 50%">
                <button onclick="toggle('courseRestore')" class="btn btn-primary toggle"
                        style="background-color: #00A6D6;">
                    <h2 class="text-center" style="font-size: 1.2em;">Restore course</h2>
                </button>
                <br>
                <form id="courseRestore" action = "/courseRestore" method = "post" class="form-group" style="width:70%; margin-left:15%; display: none">
