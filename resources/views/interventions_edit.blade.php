<div class="modal fade" id="editIntervention">
                ...
                <form id={{"intervention" . $intervention->id}} method="post" value = "<?php echo csrf_token(); ?>" action="{{action('App\Http\Controllers\InterventionsController@editIntervention',$intervention->id)}}">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type='text' class="form-control" id='editStart' name="editStart" value="{{$intervention->start_day}}" />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type='text' class="form-control" id='editEnd' name="editEnd" value="{{$intervention->end_day}}"/>
                        </div>
                        <script type="text/javascript">
                            $(function () {
